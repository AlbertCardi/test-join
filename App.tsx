...
import {
  ...
  JoinStoriesView,
  JoinStoriesCardView,
} from '@join-stories/react-native-widgets';
...
function App() {
  ...
  useEffect(() => {
     ...
     */
    const playerListener = JoinStories.addPlayerListener(
      ({listener: newListener, state: newState}) => {
        switch (newListener) {
          case 'onStoryLoaded': {
